...
export default {
  ...
  setup(props) {
    ...
    watch(
      () => props.data,
      (newValue, oldValue) => {
        startMale.value = oldValue ? oldValue[0].value : newValue[0].value;
        endMale.value = newValue[0].value;
        startFemale.value = oldValue ? oldValue[1].value : newValue[1].value;
        endFemale.value = newValue[1].value;
      },
      {
        immediate: true
      }
