...
export default {
  ...
  setup(props) {
    ...
    const listData = computed(() => {
      return props.data.slice(currentIndex, currentIndex.value + 3);
    });
    const headerData = computed(() => {
      return [
        {
          title: listData.value[0].city,
          img:
            "https://zzh-demo.oss-cn-hangzhou.aliyuncs.com/datav-screen/TB1Z171qebviK0jSZFNXXaApXXa-30-29.png"
        },
        {
          title: listData.value[1].city,
          img:
            "https://zzh-demo.oss-cn-hangzhou.aliyuncs.com/datav-screen/TB1b8Tzq7T2gK0jSZFkXXcIQFXa-28-24.png"
        },
        {
          title: listData.value[2].city,
          img:
            "https://zzh-demo.oss-cn-hangzhou.aliyuncs.com/datav-screen/TB12MbzqYY1gK0jSZTEXXXDQVXa-28-30.png"
        }
      ];
    });
